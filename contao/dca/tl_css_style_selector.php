...
$GLOBALS['TL_DCA']['tl_css_style_selector'] = [
    ...
    'palettes' => [
        'default' => '
        {style_legend},styleDesignation,styleGroup;
        {css_legend},cssClasses;
        {permissions_legend},disableInArticle,disableInContent,disableInCalendarEvent,disableInForm,disableInFormField,disableInLayout,disableInModule,disableInNews,disableInPage
        ',
    ],
    // Fields
    'fields'   => [
